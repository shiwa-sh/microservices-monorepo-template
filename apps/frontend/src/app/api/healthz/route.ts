// Liveness/readiness endpoint for the in-cluster frontend (ADR-0011, ADR-0016).
//
...
// the failure mode ADR-0011 calls out for liveness and which matters just as much
